                            ...
                            Column(
                                ...
                                Row(
                                    ...
                                    Button(
                                        ...
                                        onClick = { },
                                        size = ButtonSize.lg,
                                        type = ButtonType.primary, disable = false
                                    )
                                    Button(
                                        label = stringResource(R.string.primary),
                                        onClick = { },
                                        size = ButtonSize.lg,
                                        type = ButtonType.primary, disable = true
                                    )
                        ...
                        content = {
                            Column(
                                ...
                                Row(
                                    ...
                                    Button(
                                        label = stringResource(R.string.iconleft),
                                        onClick = { },
                                        size = ButtonSize.lg,
                                        type = ButtonType.primary,
                        ...
                        content = {
                            Column(
                                ...
                                Row(
                                    ...
                                    Button(
                                        label = stringResource(R.string.iconRight),
                                        onClick = { },
                                        size = ButtonSize.lg,
                                        type = ButtonType.primary,
...
fun Button(
    ...
    val buttonStyle = remember(type, size) {
        when (type) {
            ButtonType.primary -> {
                when (size) {
